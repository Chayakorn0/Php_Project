    ...
    <div class="container mt-4 text-center">
        ...
        <?php if ($count > 0) { ?>
            <form action="searchData.php" method="POST">
                ...
                <input type="text" name="empname" id="" class="form-control mb-4 shadow p-3 mb-5 bg-body-tertiary rounded">
        ...
        <?php } else { ?>
            <div class="alert alert-danger" role="alert">
                ...
                <p class="fs-5">ไม่มีข้อมูลพนักงานในฐานข้อมูล</p>
                <hr>
                <p class="mb-0 fs-3">โปรดเพิ่มข้อมูลในฐานข้อมูลก่อน!</p>
            </div>
        <?php } ?>
        <a href="insertForm.php" class="btn btn-primary fs-5 mx-1">บันทึกข้อมูลพนักงาน</a>
        <?php if ($count > 0) { ?>
